...
def lightgbm_make(train_feat, test_feat):
    ...
    # train_preds[train_preds >= 7.8] = train_preds[train_preds >= 7.8] + (train_preds[train_preds >= 7.8] - 7.5) * 2
    ...
    # test_preds = test_preds[:,0]*0.19 + test_preds[:,1]*0.19 + test_preds[:,2]*0.19 + test_preds[:,3]*0.19 \
    #                     + test_preds[:, 4] * 0.19 + test_preds[:,5]*0.05
